...
const CrystalMarketplace = (client) => {
  const marketplaceAddress = process.env.REACT_APP_CRYSTAL_MARKET_CONTRACT_ADDRESS
  const tokenAddress = process.env.REACT_APP_CRYSTAL_CONTRACT_ADDRESS
...
export default CrystalMarketplace
