...
const Empty = () => {
  ...
  return (
    <Grid container className={classes.pageContainer} alignItems="flex-start !important">
      <Grid item xs={12} sx={{ textAlign: '-webkit-center' }}>
        <Grid item xs={12} lg={8}>
          ...
          >
            <Typography className={classes.h2}>There are no eggs or dragons in your wallet.</Typography>
